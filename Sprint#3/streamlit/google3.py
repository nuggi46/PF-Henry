...
ruta3 = "highRest_dummies.parquet"
tabla_parquet3 = pq.read_table(ruta3)
highdf = tabla_parquet3.to_pandas()
...
### Matriz
# Creamos una columna para identificar la interaccion usuario-restaurante
df_restaurante['interaccion'] = df_restaurante['user_id'].astype(str) + '_' + df_restaurante['gmap_id'].astype(str)
